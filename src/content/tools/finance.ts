...
The figure worth stopping on is the first-year breakdown. On a twenty-year loan at typical rates, something like ninety-five per cent of the first year's instalments is interest and about five per cent reduces what you owe. People discover this at the end of year one, look at the outstanding balance, and conclude something has gone wrong. Nothing has: a reducing-balance loan charges interest on a balance that starts at its largest, and the principal only begins to fall meaningfully in the second half of the term. Seeing it stated before you sign is better than discovering it afterwards.
